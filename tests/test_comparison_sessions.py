...
def _detail(listing_id: int, **overrides) -> ListingDetailReadModel:
    base = dict(
        ...
        price_per_effective_private_room=None,
        price_per_effective_private_room_score=None,
        absolute_price_score=None,
        suspicious_low_price_flag=False,
        market_baseline_level_used=None,
        market_baseline_sample_size=None,
        market_baseline_median_price_per_m2=None,
        market_baseline_explanation=None,
        history_snapshots=(),
        change_events=(),
    )
